...
describe Gyoku do
  ...
  it "converts a complex Hash into XML" do
    ...
    if WeatherVane.ruby_19?
      ...
      generated_xml.should match /<gem>Gyoku<\/gem>/
      generated_xml.should match /<title count="2">List<\/title>/
      generated_xml.should match /<item type="Baz"><name>Foo<\/name><\/item>/
      generated_xml.should match /<item type="Foz"><name>Bar<\/name><\/item>/
    end
  end
  ...
  it "does not support @ prefixed keys, as generated by Nori" do
    ...
    if WeatherVane.ruby_19?
      ...
      generated_xml.should_not match /<item type="Bar">/
      generated_xml.should match /<item>.*<@type>Bar<\/@type>.*<\/item>/
    end
  end
end